...
npx @xenova/transformers --download --model_id distilgpt2 --local-dir "%MODEL_DIR%/distilgpt2"

echo.
echo Downloading Llama-3.2-1B-Instruct...
npx @xenova/transformers --download --model_id onnx-community/Llama-3.2-1B-Instruct --local-dir "%MODEL_DIR%/Llama-3.2-1B-Instruct"

echo.
echo Downloading DeepSeek-R1-Distill-Qwen-1.5B...
npx @xenova/transformers --download --model_id deepseek-ai/DeepSeek-Coder-V2-Lite-Base-GGUF --local-dir "%MODEL_DIR%/DeepSeek-R1-Distill-Qwen-1.5B"

echo.
echo Downloading Xenova/gpt2...
npx @xenova/transformers --download --model_id Xenova/gpt2 --local-dir "%MODEL_DIR%/Xenova/gpt2"
